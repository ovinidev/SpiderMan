...
import {
	animationFromLeft,
	animationFromRight,
} from './animations/animateOnRender';
	...
	return (
		...
		>
			...
			>
				...
				>
					<Image src="/spiderman-text.svg" alt="spider man text" w="100%" />

					<Text mt="15x" color="#959698" fontSize="1.125rem" fontWeight={400}>
					...
					<HStack mt="47px" spacing="6">
						<ButtonWithBackground />
						<ButtonOnlyBorder />
					</HStack>

					<HStack spacing="8" mt="47px">
						<Image src="/ps.svg" h={8} />
						<Image src="/marvel.svg" h={8} />
					</HStack>
				</Flex>
				...
				>
					<Image src="/spider.svg" alt="spider man" w={1200} />
				</Flex>
			</Flex>
		</Flex>
	);
